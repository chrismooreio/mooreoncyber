...
const POSTS = [
  ...
  },
  {
    ...
    title: 'DISA STIG Automation in GCC High: From PowerSTIG to Auditor Evidence',
    description: "What a production PowerSTIG pipeline produces in Azure Government — compiled MOF, audit-mode compliance verification, V-number-aligned CSV, and DISA-ready CKL. The architecture that turns Windows STIG compliance from a multi-week manual project into a repeatable evidence pipeline.",
